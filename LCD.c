...
const char welcome_string[2][16] = {"    CENG 336    ", "   TAMAGOTCHI   "};
char happy_string[2][16] = {"MONEY:", "HAPPY:"};
char hunger_string[2][16] = {"MONEY:","HUNGER"};
char thirst_string[2][16] = {"MONEY:", "THIRST"};
int pressed_time = 0;
int start = 1;
/**********************************************************************
 * ----------------------------- LCD TASK -----------------------------
